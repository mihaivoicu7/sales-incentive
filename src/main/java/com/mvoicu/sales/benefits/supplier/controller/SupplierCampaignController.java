...
import com.mvoicu.sales.benefits.supplier.service.SupplierCampaignService;
...
public class SupplierCampaignController {

    private final Logger log = LoggerFactory.getLogger(SupplierCampaignController.class);

    private static final String ENTITY_NAME = "campaign";

    private final SupplierCampaignService campaignService;

    public SupplierCampaignController(SupplierCampaignService campaignService) {
