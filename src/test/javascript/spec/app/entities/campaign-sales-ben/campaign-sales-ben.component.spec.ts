...
import { CampaignSalesBenComponent } from 'app/entities/campaign-sales-ben/campaign-sales-ben.component';
...
describe('Component Tests', () => {
    describe('CampaignSalesBen Management Component', () => {
        let comp: CampaignSalesBenComponent;
        let fixture: ComponentFixture<CampaignSalesBenComponent>;
        let service: CampaignSalesBenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [SalesBenefitTestModule],
                declarations: [CampaignSalesBenComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CampaignSalesBenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CampaignSalesBenComponent);
