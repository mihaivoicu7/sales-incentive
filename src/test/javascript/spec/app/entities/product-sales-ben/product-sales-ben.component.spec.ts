...
import { ProductSalesBenComponent } from 'app/entities/product-sales-ben/product-sales-ben.component';
...
describe('Component Tests', () => {
    describe('ProductSalesBen Management Component', () => {
        let comp: ProductSalesBenComponent;
        let fixture: ComponentFixture<ProductSalesBenComponent>;
        let service: ProductSalesBenService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [SalesBenefitTestModule],
                declarations: [ProductSalesBenComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ProductSalesBenComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ProductSalesBenComponent);
